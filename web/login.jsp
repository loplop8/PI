            ...
            <div class="container-fluid" id="Usuario">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <li class="nav-item dropdown " id="puntoNegro" >
                  ...
                  <a href="#" class="nav-link px-2 text-white mt-2 elementosResponsive"><button type="button" class="btn btn-outline-warning  me-2"><a href="login.html" id="login"> Iniciar sesi�n</a></button></a>
                    ...
                    <div class="form-content">
                        <div class="form-items">
                            ...
                            <form method="post" >
                               ...
                               <div class="col-md-12">
                                  <input class="form-control" type="password" name="password" placeholder="Contrase�a" required>
