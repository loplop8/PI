...
<html>
    <head>
        ...
        <script src="../js/tablaHilos.js" defer></script> 
                                ...
                                <c:if test="${usuario.id_usuario!=null}">
                                    ...
                                    <ul class="dropdown-menu-dark  dropdown-menu  "
                                        ...
                                        <c:if test="${usuario.rol=='moderador'}">
                                            <li><a class="dropdown-item" href="./PanelModeracion"> <svg
                                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="currentColor" class="bi bi-pc-display-horizontal"
                                                        viewBox="0 0 16 16">
                                                        <path
                                ...
                                <div class="col-md-12">
                                    <div class="card mt-3">
                                        <div class="card-header bg-dark text-light">
                                            <h5 class="mb-0 text-center" >Moderar Hilos</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="PedidosTable" class="table text-white" >
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center align-middle">Creador del Hilo</th>
                                                            <th class="text-center align-middle">Puntuacion del Usuario</th>
                                                            
                                                            <th class="text-center align-middle">Nombre del Hilo</th>
                                                            <th class="text-center align-middle">Tema del Hilo</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach  items="${hilos}" var="h">
                                                            <tr>
                                                                
                                                                <td class="text-center align-middle"> ${h.id_usuario.nickname}</td>
                                                                <td class="text-center align-middle"> ${h.id_usuario.puntuacion_foro}</td>
                                                                <td class="text-center align-middle"> ${h.titutlo_descriptivo}</td>
                                                                <td class="text-center align-middle"> ${h.etiqueta_tema}</td>
                                                                <td class="text-center align-middle"> <fmt:formatDate value="${h.fecha_creacion}" pattern="dd-MM-yyyy"/></td>
                                                                <td class="text-center align-middle">
                                                                <form action="./PuntuarUsuario" method="post" >
                                                                    <input type="hidden" name="usuarioHilo" value="${h.id_usuario.id_usuario}" />
                                                                    <input type="submit" class="btn btn-warning" value="Puntuar Negativamente al usuario"/>
                                                                </form>
                                                            </td>
                                                                <td class="text-center align-middle">
                                                                <form action="./ModerarMensajes" method="post" >
                                                                    <input type="hidden" name="hilo" value="${h.id_hilo}" />
                                                                    <input type="submit" class="btn btn-success" value="Ver mensajes de este hilo"/>
                                                                </form>
                                                                    
                                                            </td>
                                                            <td class="text-center align-middle">
                                                                <form action="./BorrarHilo" method="post" >
                                                                    <input type="hidden" name="hilo" value="${h.id_hilo}" />
                                                                    <input type="submit" class="btn btn-danger" value="Borrar Hilo"/>
                                                                </form>
