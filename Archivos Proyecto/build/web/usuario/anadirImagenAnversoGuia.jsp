                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    <h3>Añadir Anveso de su Guia de Armas</h3>
                                    <p>Añada una foto clara del anverso de su Guia</p>
                                        <form action="./AnadirImagenAnversoGuia" method="post" enctype="multipart/form-data">
