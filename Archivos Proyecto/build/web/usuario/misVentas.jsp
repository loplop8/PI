...
<html>
    ...
    <script src="../js/misVentas.js" defer></script> 
            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-header bg-dark text-light">
                        <h5 class="mb-0 text-center" >Mis Ventas</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="VentasTable" class="table text-white" >
                                <thead>
                                    <tr>
                                       <th class="text-center align-middle">Número del Pedido</th>
                                        ...
                                        <th class="text-center align-middle">Fecha Venta</th>
                                        <th class="text-center align-middle">Fecha Entrega Comprador</th>
                                        <th class="text-center align-middle">Estado del Pedido</th>
                                        <th class=" text-center align-middle">Ganancias</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <c:forEach items="${anuncios}" var="a">
                                                <c:if test="${a.id_arma.id_arma==p.id_arma.id_arma}">
                                                    ${a.precio}
                                                </c:if>
                                        </c:forEach></td>
