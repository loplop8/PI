                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    <h3>Añadir Anveso Licencia de Armas</h3>
                                    <p>Añada una foto clara del anverso de su licencia</p>
                                        <form action="./AnadirImagenAnversoLicencia" method="post" enctype="multipart/form-data">
