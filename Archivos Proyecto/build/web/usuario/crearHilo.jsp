...
<html lang="en">
    <head>
        ...
        <script src="../js/crearHilo.js" defer></script>
                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    ...
                                    <form class="requires-validation" method="post" id="formulario">
                                        <div class="row">
                                        <div class="col-md-6 mt-1">
                                            <label for="nombre">Titulo Descriptivo:</label>
                                            <input class="form-control " type="text" name="titulo_descriptivo"  placeholder="Titulo del Hilo"  required/>
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <label for="apellidos">Tema del Hilo:</label>
                                            <input class="form-control " type="text" name="tema"  placeholder="Tema" required />
                                        </div>
                                        </div>
                                    ...
                                    <div class="form-button mt-3">
                                        <input id="submit" type="submit"  class="btn btn-primary" value="Crear Hilo">
