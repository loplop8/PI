                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    <h3>Se ha creado la siguiente licencia</h3>
                                    <label>Ahora solo falta que el administrador confirme que la licencia es valida, esto podra verlo en la seccion Mis Licencias</label>
                                    
                                        <div class="row mt-5">
                                        <div class="col-md-6 mt-1">
                                            <label for="tipo_licencia">Tipo Licencia</label>
                                            <label>${licencia.id_tipo_licencia.tipo}</label>
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <label for="valida_desde">Valida Desde:</label>
                                            <label><fmt:formatDate value="${licencia.valida_desde}" pattern="dd-MM-yyyy"/></label>
                                        </div>
                                        </div>
                                        <div class="row">
                                        <div class="col-md-6 mt-1">
                                            <label for="valida_hasta">Valida Hasta:</label>
                                            <label><fmt:formatDate value="${licencia.valida_hasta}" pattern="dd-MM-yyyy"/></label>
                                        </div>
                                        
                                        <div class="col-md-6 mt-1">
                                            <label for="valida_desde">Fecha expedicion:</label>
                                            <label><fmt:formatDate value="${licencia.fecha_expedicion}" pattern="dd-MM-yyyy"/></label>
                                        </div>
                                            </div>
                                        <div class="row">
                                        <div class="col-md-6  mt-1">
                                            <label for="observaciones">Observaciones:</label>
                                            <label>${licencia.observaciones}</label>
                                        </div>
                                            <div class="col-md-6 mt-1" >
                                            <label for="restricciones">Restricciones</label>
                                            <label>${licencia.restricciones}</label>
                                            </div>
                                        ...
                                        <div class="col-md-6  mt-1">
                                            ...
                                            <img src="${licencia.url_img_licencia_anverso}" width="150">
                                        </div>
                                        <div class="col-md-6  mt-1">
                                            <label for="Anverso">Reverso</label>
                                            <img src="${licencia.url_img_licencia_reverso}" width="150">
                                        </div>
                                        
                                 <div class="col-md-12 mt-2">
                                           
                                               <button
                                            type="button" class="btn btn-outline-warning  me-2"><a href="./GestionarPerfil"
                                                id="login"> Volver al Perfil</a></button></a>                             
                                 </div>
