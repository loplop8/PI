...
<html lang="en">
    <head>
        ...
        <script src="../js/addLicencia.js" defer></script>
                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    <h3>Añadir Licencia Armas</h3>
                                    <p>Añada sus datos tal y como vienen en su licencia de armas</p>
                                    <form class="requires-validation"  method="post">
                                        <div class="row">
                                        <div class="col-md-6 mt-1">
                                            <label for="tipo_licencia">Tipo Licencia</label>
                                            <select class="form-select mt-3" name="tipo_licencia" id="tipo_licencia" required>
                                                <option value="">Seleccione un tipo</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <label for="valida_desde">Valida Desde:</label>
                                            <input class="form-control " type="date" name="valida_desde"  required />
                                        </div>
                                        </div>
                                        <div class="row">
                                        <div class="col-md-6 mt-1">
                                            <label for="valida_hasta">Valida Hasta:</label>
                                            <input class="form-control " type="date" name="valida_hasta"  required />
                                        </div>
                                        
                                        <div class="col-md-6 mt-1">
                                            <label for="valida_desde">Fecha expedicion:</label>
                                            <input class="form-control " type="date" name="fecha_expedicion"  required />
                                        ...
                                        <div class="col-md-6 mt-1" >
                                            ...
                                            <input class="form-control " type="text" name="restricciones"   />
                                        </div>
                                            </div>
                                        
                                 <div class="col-md-12 mt-2">
                                           
                                            <label for="politica">Declaro que esto datos son validos</label> <input  type="checkbox" name="privacidad"  required />                                
                                 </div>
