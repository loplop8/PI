                                                ...
                                                <table id="anunciosReplica" class=" table  text-white">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">Tipo Gas</th>
                                                            <th class="text-center">Capacidad del Cargador</th>
                                                            <th class="text-center">Piezas del Cañon</th>
                                                        ...
                                                        <c:forEach items="${anuncios}" var="a">
                                                            <tr>
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <c:forEach items="${armas_replica}" var="arma">
