                        ...
                        <section class="py-1 text-center container-fluid mt-5" id="slider">
                            ...
                            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <c:set var="activeApplied" value="false" />
                                    <c:forEach items="${anuncios}" var="a" step="1" varStatus="status">
                                        <c:if test="${a.id_estado_anuncio.id_estado_anuncio==6 && activeApplied=='false'}">
                                            <c:set var="activeApplied" value="true" />
                                            <div class="carousel-item active">
                                                <form method="post" action="./VerAnuncio">
                                                    <input type="hidden" name="anuncioVer" value="${a.id_anuncio}">
                                                    <button type="submit" class="w-100">
                                                        <img src="${a.url_img_principal}" width="100%" height="400" alt="...">
                                                    </button>
                                                </form>
                                                <div class="carousel-caption d-none d-md-block"></div>
                                            </div>
                                        </c:if>
                                        <c:if test="${a.id_estado_anuncio.id_estado_anuncio==6 && activeApplied=='true'}">
