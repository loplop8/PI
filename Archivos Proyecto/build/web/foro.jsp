                                ...
                                <div class="col-md-12">
                                    <div class="card mt-3">
                                        <div class="card-header bg-dark text-light d-flex justify-content-between">
                                            <h2 class="mb-0 text-center">Bienvenidos al Foro de SWL</h2>
                                            <c:if test="${usuario.id_usuario!=null && usuario.puntuacion_foro>=(-9)}">
                                                
                                                <form action="./usuario/CrearHilo" method="post">
                                                <input type="submit" class="btn btn-success" value="Crear nuevo Hilo"/>
                                            </form>
                                                </c:if>
                                        </div>
                                        <div class="card-body">
                                            <div class=" "> 
                                                <table id="HilosTable" class="table  text-white">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="text-center">Entrar en el Hilo </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>    
                                                            ...
                                                            <td class="text-center align-middle">
                                                                <form action="VerHilo" method="post" >
                                                                    <input type="hidden" name="hiloVer" value="${h.id_hilo}" />
                                                                    <input type="submit" class="btn btn-success" value="Entrar en este hilo"/>
                                                                </form>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
