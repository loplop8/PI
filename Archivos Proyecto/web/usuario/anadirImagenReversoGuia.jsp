                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    <h3>Añadir Reveso de su Guia de Armas</h3>
                                    <p>Añada una foto clara del reverso de su Guia</p>
                                        <form action="./AnadirImagenGuiaReverso" method="post" enctype="multipart/form-data">
