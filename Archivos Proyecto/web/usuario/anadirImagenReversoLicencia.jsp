                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    <h3>Añadir Reveso Licencia de Armas</h3>
                                    <p>Añada una foto clara del reverso de su licencia</p>
                                        <form action="./AnadirImagenReversoLicencia" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="submit" class="btn btn-primary mt-2" value="Seleccionar Imagen">
