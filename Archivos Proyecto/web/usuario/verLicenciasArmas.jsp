                        ...
                        <div  class="table-responsive">
                            <table id="userLicencias" class="table  text-white">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">${l.id_tipo_licencia.tipo}</td>
                                        <td class="text-center"><fmt:formatDate value="${l.fecha_expedicion}" pattern="dd-MM-yyyy"/></td>
                                        <td class="text-center"><fmt:formatDate value="${l.valida_desde}" pattern="dd-MM-yyyy"/></td>
                                        <td class="text-center"><fmt:formatDate value="${l.valida_hasta}" pattern="dd-MM-yyyy"/></td>
                                        <td class="text-center">${l.observaciones}</td>
                                        <td class="text-center">${l.restricciones}</td>
