...
<html lang="en">
    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6">
                <div id="imageSlider" class="carousel slide mb-5 mb-md-0" data-bs-ride="carousel">
            ...
            <div class="col-md-6">
                <h1 class="display-5 fw-bolder">${anuncio.titulo}</h1>
                <div class="description-wrapper">
                    <p class="lead" <c:if test="${arma_fuego!=null}">id="descripcion_fuego"</c:if> <c:if test="${arma_replica!=null}">id="descripcion_replica"</c:if> style="white-space: pre-wrap; word-wrap: break-word;">Descripcion: ${anuncio.descripcion}</p>
                </div>
                <p class="lead">Marca: ${anuncio.id_arma.marca}<br/>
                    <c:if test="${arma_fuego!=null}">
