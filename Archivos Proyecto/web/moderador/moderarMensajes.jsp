                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="MensajesTable" class="table text-white" >
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center align-middle">Creador del Mensaje</th>
                                                            <th class="text-center align-middle">Puntuacion del Usuario</th>
                                                            
                                                            <th class="text-center align-middle">Contenido</th>
                                                            
                                                            <th class="text-center align-middle">Fecha Posteo </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach  items="${mensajes}" var="m">
                                                            <tr>
                                                                ...
                                                                <td class="text-center align-middle"> ${m.id_usuario.nickname}</td>
                                                                <td class="text-center align-middle"> ${m.id_usuario.puntuacion_foro}</td>
                                                                <td class="text-center align-middle"> ${m.contenido}</td>
                                                                
                                                                <td class="text-center align-middle"> <fmt:formatDate value="${m.fecha_publicacion}" pattern="dd-MM-yyyy"/></td>
                                                                <td class="text-center align-middle">
                                                                <form action="./PuntuarUsuario" method="post" >
                                                                    <input type ="hidden" name="hilo" value="${m.id_hilo.id_hilo}" /> 
                                                                    <input type="hidden" name="usuarioMensaje" value="${m.id_usuario.id_usuario}" />
                                                            ...
                                                            <td class="text-center align-middle">
                                                                <form action="./BorrarMensaje" method="post" >
                                                                    <input type ="hidden" name="hilo" value="${m.id_hilo.id_hilo}" />
                                                                    <input type="hidden" name="mensaje" value="${m.id_mensaje}" />
                                                                    <input type="submit" class="btn btn-danger" value="Borrar Mensaje"/>
                                                                </form>
