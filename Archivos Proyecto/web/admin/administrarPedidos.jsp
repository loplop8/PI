...
<html>
    ...
    <script src="../js/tablaPedidos.js" defer></script> 
            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-header bg-dark text-light">
                        <h5 class="mb-0 text-center" >Pedidos</h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center  align-middle">
                                            <form action="./CambiarEstadoPedido" method="post">
                                                <input type="submit" class="btn btn-sm btn-success" <c:if test="${p.id_estado_pedido.id_estado_pedido==4}"> disabled </c:if>  value="Cambiar al siguiente estado"/>       
