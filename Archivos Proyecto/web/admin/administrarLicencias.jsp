...
<html>
    <head>
        ...
        <script src="../js/tablaLicencias.js" defer></script> 
            ...
            <div>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start w-100 "
                    ...
                    <main>
                                ...
                                <div class="col-md-12">
                                    <div class="card mt-3">
                                        <div class="card-header bg-dark text-light">
                                            <h5 class="mb-0 text-center" >Licencias</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="LicenciasTable" class="table  text-white">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center">Nickname Usuario</th>
                                                            <th class="text-center">Tipo Licencia</th>
                                                            <th class="text-center">Fecha Expedición</th>
                                                            <th class="text-center">Válida Desde</th>                                        
                                                            <th class="text-center">Válida Hasta</th>
                                                            <th class="text-center">Observaciones</th>
                                                            <th class="text-center">Restricciones</th>
                                                            <th class="text-center">Imagen Anverso</th>
                                                            <th class="text-center">Imagen Reverso</th>
                                                            <th class="text-center">Validada Admin</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach items="${licencias}" var="l">
                                                            <tr>
                                                                <td class="text-center align-middle">${l.id_usuario.nickname}</td>
                                                                <td class="text-center align-middle">${l.id_tipo_licencia.tipo}</td>
                                                                <td class="text-center align-middle"><fmt:formatDate value="${l.fecha_expedicion}" pattern="dd-MM-yyyy"/></td>
                                                                <td class="text-center align-middle"><fmt:formatDate value="${l.valida_desde}" pattern="dd-MM-yyyy"/></td>
                                                                <td class="text-center align-middle" ><fmt:formatDate value="${l.valida_hasta}" pattern="dd-MM-yyyy"/></td>
                                                                <td class="text-center align-middle">${l.observaciones}</td>
                                                                <td class="text-center align-middle">${l.restricciones}</td>
                                                                <td class="text-center align-middle">
                                                                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#licenciaA${l.id_licencia}">
                                                                        <img src="${l.url_img_licencia_anverso}" width="50" alt="Anverso "/>
                                                                    </button>
                                                                </td>
                                                                <td class="text-center align-middle">
                                                                    <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#licenciaR${l.id_licencia}">
                                                                        <img src="${l.url_img_licencia_reverso}" width="50" alt="Reverso "/>
                                                                    </button>
                                                                </td>
                                                                <c:if test="${l.licencia_validada}">
                                                                    <td class="text-center align-middle">Sí</td>
                                                                </c:if>
                                                                <c:if test="${!l.licencia_validada}">
                        ...
                        <c:forEach  items="${licencias}" var="l">
                            <div tabindex="-1 " aria-labelledby="licenciaA${l.id_licencia}" aria-hidden="true" class="modal fade" id="licenciaA${l.id_licencia}">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <img src="${l.url_img_licencia_anverso}" alt="">
                                    </div>
                                </div>
                            </div>

                            <div tabindex="-1 " aria-labelledby="licenciaR${l.id_licencia}" aria-hidden="true" class="modal fade" id="licenciaR${l.id_licencia}">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <img src="${l.url_img_licencia_reverso}" alt="">
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
