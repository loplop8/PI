                                    ...
                                    <div class="form-holder">
                                        <div class="form-content">
                                            <div class="form-items">
                                                <h3>Edite este anuncio</h3>
                                                <p>Inserte los datos del anuncio  </p>
                                                <form class="requires-validation" action="./AdminEditarAnuncio" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mt-1">
                                                                <label for="descripcion">Seleccione las nuevas Imagenes : (Total Maximo=100MB) <br> Si no selecciona ninguna se quedaran las anteriores</label>
