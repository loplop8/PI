 ...
 * @author Zatonio
 */
@WebServlet(name = "AdministrarAnunciosReplica", urlPatterns = {"/admin/AdministrarAnunciosReplica"})
public class AdministrarAnunciosReplica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = "/admin/administrarAnunciosReplica.jsp";
        Usuario usuario = (Usuario) request.getSession().getAttribute("usuario");
        request.setAttribute("usuario", usuario);
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("SecondWeaponLife"); 
        AnuncioJpaController ajc = new AnuncioJpaController(emf);
        List<Anuncio>anuncios=ajc.obtenerListaAnunciosArmasReplica();
        request.setAttribute("anuncios",anuncios);
        
        
        
        ArmaReplicaJpaController arjc= new ArmaReplicaJpaController(emf);
        request.setAttribute("armas_replica", arjc.findArmaReplicaEntities());
