...
@WebServlet(name = "AdminBorrarAnuncio", urlPatterns = {"/admin/AdminBorrarAnuncio"}  )
public class AdminBorrarAnuncio extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AdminBorrarAnuncio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
