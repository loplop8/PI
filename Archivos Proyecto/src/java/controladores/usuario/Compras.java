 ...
 * @author Zatonio
 */
@WebServlet(name = "Compras", urlPatterns = {"/usuario/Compras"})
public class Compras extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = "/usuario/misCompras.jsp";
        ...
        for (Pedido pedido: pjc.findPedidoEntities()) {
            if(pedido.getId_usuario().getId_usuario().equals(usuario.getId_usuario())){
                pedidos.add(pedido);
         }
        }
        ...
        for(Factura factura:fjc.findFacturaEntities() ){
            if(factura.getId_pedido().getId_usuario().getId_usuario().equals(usuario.getId_usuario())){
        ...
        for(ContratoCompraVenta contrato:ccjc.findContratoCompraVentaEntities()){
            if(contrato.getId_factura().getId_pedido().getId_usuario().getId_usuario().equals(usuario.getId_usuario())){
