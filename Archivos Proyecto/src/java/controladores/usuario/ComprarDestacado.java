 ...
 * @author Zatonio
 */
@WebServlet(name = "ComprarDestacado", urlPatterns = {"/usuario/ComprarDestacado"})
public class ComprarDestacado extends HttpServlet {
...
transaction.setDescription("Anuncio Destacado: " + a.getTitulo());

Payment payment = new Payment();
payment.setIntent("sale");

RedirectUrls redirectUrls = new RedirectUrls();
redirectUrls.setReturnUrl("http://localhost:8080/SecondWeaponLife/usuario/CompraDestacadoCompletada");
