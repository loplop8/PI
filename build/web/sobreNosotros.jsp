...
<body>
                            ...
                            <div class="container-fluid" id="Usuario">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <li class="nav-item dropdown " id="puntoNegro" >
                                        ...
                                        <a href="sobreNosotros.html" class="nav-link px-2 text-white mt-2 elementosResponsive">Sobre Nosotros</a>

                                        <a href="#" class="nav-link px-2 text-white mt-2 elementosResponsive" >Como Trabajamos</a>
                                        <a href="#" class="nav-link px-2 text-white mt-2 elementosResponsive">Foro</a>
                                        </a>
  ...
  <div class="container-fluid  flex-sm-row  " id="aprender">
    ...
    <div class="container-fluid  flex-sm-row text-center pt-5">  
        <h2>¿Quieres saber más acerca de nuestros servicios?</h2>    
        
    <p>Somos una empresa dedicada a la gestión de la compra-venta de armas entre particulares.</p>
    ...
    <div class="row">
      <div class="col-md-6 order-md-1 order-2">
        <div class="card bg-dark text-white">
          <div class="card-body">
            <h3 class="card-title">Amantes del tiro olímpico</h3>
            <p class="card-text">¡Hola a todos los entusiastas del tiro olímpico! En Second Weapon Life, nos apasiona ayudarte a alcanzar tus objetivos en este emocionante deporte!</p>
          </div>
        </div>
      ...
      <div class="col-md-6 order-md-2 order-1">
        <div class="card bg-dark text-white">
          <div class="card-body">
            ...
            <p class="card-text">Saludos cazadores! En Second Weapon Life, estamos dedicados a ayudarte a encontrar las mejores armas de caza para que puedas disfrutar de tu pasión al máximo!</p>
          </div>
        </div>
    ...
    <div class="rounded-circle">
      ...
      <div class="container-fluid row text-center m-5" >
        ...
        <div class="col-sm-3">
          ...
          <p>Publicación de anuncios de armas totalmente gratuitos en el momento</p>
        </div>
        <div class="col-sm-3">
        ...
        <div class="bloque7">
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-8">
                <p class="lead">Nuestros profesionales totalmente cualificados serán los que decidan que armas son aptas para poder ser enviadas a traves de nuestra pagina web. Por ello ofrecemos una garnatia de 15 días para la prueba y ver que todo esta en regla.Además, entendemos la importancia de la seguridad en la compra y venta de armas, por lo que nos aseguramos de seguir todas las regulaciones y leyes aplicables en cada país donde ofrecemos nuestros servicios.

                  También ofrecemos una amplia gama de opciones de envío, desde el envío estándar hasta el envío urgente, para garantizar que los clientes reciban sus armas de manera rápida y segura. Nos aseguramos de que cada envío esté asegurado y empaquetado de manera segura para minimizar cualquier riesgo durante el transporte.
                  
                  Nos enorgullece proporcionar un servicio excepcional y de alta calidad a nuestros clientes, y nos comprometemos a brindarles la mejor experiencia posible en su compra o venta de armas. Si tiene alguna pregunta o inquietud, no dude en comunicarse con nuestro equipo de soporte al cliente, quienes estarán encantados de ayudarlo en todo lo que necesite.</p>
              </div>
            </div>
          </div>
        </div>
